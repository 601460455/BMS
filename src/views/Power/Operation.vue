  ...
  <el-table
    ...
    <el-table-column label="操作">
      <template slot-scope="scope" >
        ...
        <el-button
          size="mini"
          @click="handleEdit(scope.$index, scope.row)" style="margin-left:10px">权限</el-button>
        <el-button
          size="mini"
          :key='scope.row.id'
...
export default {
    ...
    created(){
      this.$http
      .get('https://www.fastmock.site/mock/3dd33af66b86aaac51b02d0ff90da8cc/station/station')
      .then((ret) => {
        this.tableData = ret
        console.log(ret)
      })
